...
public class ParentChildAnalyzer5 extends ParentChildAnalyzer4 {
	public HashMap<String, _ParentDoc2> parentHashMap;

	public ParentChildAnalyzer5(String tokenModel, int classNo,
	...
	public void analyzeChildDoc(_ChildDoc2 doc) {
		...
		for (String token : tokens) {
			if (!m_isCVLoaded) {
				...
				} else {// indicate we allow the analyzer to dynamically expand
