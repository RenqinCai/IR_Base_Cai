...
public class _Doc implements Comparable<_Doc> {
	...
	protected _SparseFeature[] m_x_sparse; // sparse representation of features:
	...
	public void setTokens(String[] tokensArray) {
		m_tokens = new String[tokensArray.length];
		for (int i = 0; i < tokensArray.length; i++) {
			m_tokens[i] = tokensArray[i];
		}
	}
